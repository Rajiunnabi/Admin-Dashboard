          ...
          <div className="px-4 sm:px-6 lg:px-8 pb-8 pt-8 grid grid-cols-2 gap-x-10 max-xl:grid-cols-1 max-xl:gap-y-10">
            ...
            <div>
              ...
              <div className="flex justify-center gap-x-2 mt-5 flex-wrap">
                <img src='/assets/tablet (1).jpg' alt='' className="w-36 h-32"/>
                <img src="/assets/tablet (2).jpg" alt="" className="w-36 h-32" />
                <img src='/assets/tablet (3).jpg' alt='' className="w-36 h-32"/>
                <img src="/assets/tablet (4).jpg" alt="" className="w-36 h-32" />
              </div>
            </div>
          </div>
        </div>
