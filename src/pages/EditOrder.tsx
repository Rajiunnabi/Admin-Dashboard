                ...
                <div className="mt-5">
                  ...
                  <div className="mt-4 flex flex-col gap-5 max-[450px]:items-start">
                    <div className="flex justify-between items-center max-[450px]:flex-col">
                      ...
                      <img src="/assets/tablet (1).jpg" alt="product" className="w-12 h-12" />
                    ...
                    <div className="flex justify-between items-center max-[450px]:flex-col">
                      <div className="flex items-center gap-3  max-[450px]:flex-col">
                      <img src="/assets/tablet (2).jpg" alt="product" className="w-12 h-12" />
                    ...
                    <div className="flex justify-between items-center max-[450px]:flex-col">
                      <div className="flex items-center gap-3  max-[450px]:flex-col">
                      <img src="/assets/tablet (3).jpg" alt="product" className="w-12 h-12" />
